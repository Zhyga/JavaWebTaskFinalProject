...
public class PasswordEncryptorTest {
    @DataProvider(name = "encryptPasswordPositiveData")
    ...
    @Test(dataProvider = "encryptPasswordPositiveData")
    public void encryptPasswordPositiveTest(String password, String expected) {
        Optional<String> actual = PasswordEncryptor.encryptPassword(password);
        assertEquals(actual.get(), expected);
    }

    @DataProvider(name = "encryptPasswordNegativeData")
    ...
    @Test(dataProvider = "encryptPasswordNegativeData")
