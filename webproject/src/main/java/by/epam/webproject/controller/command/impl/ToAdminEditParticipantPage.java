    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            ...
            if(participantOptional.isPresent()){
                request.setAttribute(RequestAttribute.JOCKEY,participantOptional.get().getJockey());
                request.setAttribute(RequestAttribute.HORSE,participantOptional.get().getHorse());
                request.setAttribute(RequestAttribute.WEIGHT,participantOptional.get().getWeight());
            }
